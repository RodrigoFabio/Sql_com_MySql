...
SELECT * FROM tbcliente WHERE IDADE >= 18 AND IDADE <= 35;
SELECT * FROM tbcliente WHERE (IDADE >= 18 AND IDADE <= 22 AND SEXO = 'M') OR (cidade = 'Rio de Janeiro' OR BAIRRO = 'Jardins');

USE sucos;
CREATE TABLE tbproduto(PRODUTO VARCHAR(20), NOME VARCHAR(150), EMBALAGEM VARCHAR(50), TAMANO VARCHAR(50), SABOR VARCHAR (50), PRECO_LISTA FLOAT);
...
INSERT INTO tbproduto (PRODUTO, NOME, EMBALAGEM, TAMANHO, SABOR, PRECO_LISTA) VALUES('1037797','Clean - 2 Litros - Laranja','PET','2 Litros'	,'Laranja',16.01);
INSERT INTO tbproduto (PRODUTO, NOME, EMBALAGEM, TAMANHO, SABOR, PRECO_LISTA) VALUES('1000889','Sabor da Montanha - 700 ml - Uva','Garrafa','700 ml','Uva',6.31);
INSERT INTO tbproduto (PRODUTO, NOME, EMBALAGEM, TAMANHO, SABOR, PRECO_LISTA) VALUES('1042712','Linha Citros - 700 ml - Limão','Garrafa' ,'700 ml','Limão', 4.90);
ALTER TABLE tbproduto ADD PRIMARY KEY (PRODUTO);
SELECT * FROM tbproduto; 

use sucos;
CREATE TABLE tabela_de_vendedores(MATRICULA VARCHAR(5), NOME VARCHAR(100), COMISSAO FLOAT, DATA_ADMISSAO DATE, DE_FERIAS VARCHAR(3));
ALTER TABLE tabela_de_vendedores ADD PRIMARY KEY(MATRICULA);
INSERT INTO tabela_de_vendedores (MATRICULA, NOME, COMISSAO, DATA_ADMISSAO, DE_FERIAS) VALUES('00235','Márcio Almeida Silva', 8, '2014-08-15', 'NÃO');
INSERT INTO tabela_de_vendedores (MATRICULA, NOME, COMISSAO, DATA_ADMISSAO, DE_FERIAS) VALUES('00236','Cláudia Morais', 8, '2013-09-17','SIM');
INSERT INTO tabela_de_vendedores (MATRICULA, NOME, COMISSAO, DATA_ADMISSAO, DE_FERIAS) VALUES('00237','Roberta Martins', 11, '2017-03-18','SIM');
INSERT INTO tabela_de_vendedores (MATRICULA, NOME, COMISSAO, DATA_ADMISSAO, DE_FERIAS) VALUES('00238','Péricles Alves', 11, '2016-08-21','NÃO');
SELECT * FROM tabela_de_vendedores WHERE NOME = 'Cláudia Morais';
SELECT * FROM tabela_de_vendedores WHERE DE_FERIAS = 'SIM'  AND DATA_ADMISSAO > 2016;